...
Read in the metadata - Amy ran Arielle's fibrosis algorithm and metadata code with some modifications after a RedCap download by Michele. Careful to run this all as a chunk - rerunning certain parts separately will not result in the correct metadata.
...
metadata$age <- cut (metadata$age, 25, labels = 1:25)
