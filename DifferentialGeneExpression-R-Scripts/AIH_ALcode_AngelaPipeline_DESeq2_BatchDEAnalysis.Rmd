...
filename= paste("AIH_031119", "~spl_plate+sex+age+case_hl_du", "AIHcase-vs-control", sep='_')
...
metadata <- read.csv("../AIH-metadata/AIH_metadata_firstpass_ALedits_031119.csv", header=TRUE, row.names = 1)
