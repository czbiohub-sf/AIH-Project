...
metadata <- read.csv("../AIH-metadata/FINAL_AIH_metadata_firstpass_ALedits_040219.csv", header=TRUE, row.names = 1)
...
pdf(paste(filename, "Volcanoplot.pdf", sep = "_"),width=1024,height=512) 
