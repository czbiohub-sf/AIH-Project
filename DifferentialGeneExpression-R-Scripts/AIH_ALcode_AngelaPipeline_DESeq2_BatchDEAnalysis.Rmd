...
filename= paste("AIH_041119", "~spl_plate+sex+age+steroid", "yes-vs-notx", sep='_')
...
dds$steroid<- relevel (dds$steroid, ref = "healthy")
...
setwd("../DifferentialGeneExpression-Output/AIH_DESeq2_DEGenes_041119_Steroids/")
...
ggplot(pca_dds, aes(PC1, PC2, color= steroid)) +
