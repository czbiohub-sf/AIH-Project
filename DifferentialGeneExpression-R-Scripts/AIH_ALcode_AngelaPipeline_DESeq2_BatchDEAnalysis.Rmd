...
Edit variables
```{r}
design = ~spl_plate+sex+age+response_groups
filename= paste("AIH_122018", "~spl_plate+sex+age+response_groups", "partial-vs-non-responder", sep='_')
contrast=c("response_groups", "partial", "non-responder")
```
...
setwd("../DifferentialGeneExpression-Output/Amy_DESeq2_DEGenes_122018_updateDesign/")
...
setwd("../DifferentialGeneExpression-Output/Amy_DESeq2_DEGenes_122018_updateDesign/VSD_Transformation/")
...
setwd("../DifferentialGeneExpression-Output/Amy_DESeq2_DEGenes_122018_updateDesign/MA_Plots")
