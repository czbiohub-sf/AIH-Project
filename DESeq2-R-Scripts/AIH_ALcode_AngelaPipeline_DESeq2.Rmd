...
write.csv (t_matrix_vsd, file = "VSDNormalized_case_control_minus67and94_101618.csv")
```
...
with(results_MA, plot(log2FoldChange, -log10(pvalue), pch=20, main="Volcano plot, ~ case, case vs control, minus 67 and 94", xlim=c(-3,3)))
...
setwd("~/Documents/Informatics/AIH/github/AIH-Project/AIH DESeq2 Output/")
results_significant
write.csv(results_significant, "AIH_case_v_control_minus67and94_FDR0.05.csv")
```
```{r}
