...
t_matrix_vsd <- read.csv("~/Documents/Informatics/AIH/github/AIH-Project/AIH DESeq2 Output/VSDNormalized_case_control_nooutliers_nolivertransplants_101618.csv", row.names = 1)
...
AIH_metadata$lt_before_coll <- as.numeric(AIH_metadata$lt_before_coll)


```
Trying different clustering stuffs (Amy)
```{r}
library("factoextra")
