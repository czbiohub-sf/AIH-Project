...
AIH_metadata_firstpass <- dplyr::select(AIH_metadata, aasld_id, ind_id, case_hl_du, du, spl_plate, dt_isl, date_lt, date_coll, sex, race, ethn, aih_type, te_coll, age_coll,  on_tx, igg_coll, ast_coll, alt_coll,  alp_coll, tbili_coll, response, relapse, decomp, lt, liver_death, age_hc, ast_hc, alt_hc, alkphos_hc, tbili_hc)
colnames(AIH_metadata)
...
AIH_metadata_firstpass %<>% select (aasld_id, case_hl_du, du, sex, race, ethn, aih_type, te_coll, on_tx, igg_coll, response, relapse, decomp, lt, liver_death, age, ast, alt, bili, alkp, fib4, F03_F4, spl_plate, dt_isl, date_lt, date_coll)
