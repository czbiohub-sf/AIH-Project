...
AIH_cases_QF4 <- read.csv(file = "../github/AIH-Project/AIH-metadata/AASLDAutoimmunePilot_DATA_2019-01-29_1413.csv", stringsAsFactors = FALSE)
...
overall_fibrosis_review <- read.csv ("../github/AIH-Project/AIH-metadata/AASLDAutoimmunePilot_DATA_2019-01-29_1413.csv")
...
write.csv(AIH_cases_QF4_calls, file = "19_0129_AIH_cases_QF4_calls.csv", row.names = FALSE)
